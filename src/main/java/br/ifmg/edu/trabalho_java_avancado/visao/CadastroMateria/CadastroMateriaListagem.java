 ...
 * @author Vitor
 */
public class CadastroMateriaListagem extends javax.swing.JDialog {

    /**
     * Creates new form CadastroVendedorListagem
     */
    
    private final Materia_PrimaService mService = new Materia_PrimaService();
    private List<Materia_Prima> materia_prima;
    private CadastroMateriaTableModel mTabModel;
    
    public CadastroMateriaListagem(java.awt.Frame parent, boolean modal) {
        super(parent,modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jTBBotoes.setBorder(javax.swing.BorderFactory.createTitledBorder("Cadastro - Matérias-Primas"));
    ...
    private void jBtnIncluirMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBtnIncluirMouseEntered
        ...
        jBtnIncluir.setToolTipText("Neste Botão será possível cadastrar uma Matéria Prima!!");
    ...
    private void jBtnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnIncluirActionPerformed
        // TODO add your handling code here:
        CadastroMateriaInclui dialog = new CadastroMateriaInclui(this, true, mService);
    ...
    private void jBtnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnEditarActionPerformed
        ...
        Materia_Prima m = materia_prima.get(jTableMateria.getSelectedRow());
        
        CadastroMateriaEdita dialog = new CadastroMateriaEdita(this, true, mService, m);
        dialog.setVisible(true);
        atualizaDados();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroMateriaListagem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            CadastroMateriaListagem dialog = new CadastroMateriaListagem(new javax.swing.JFrame(), true);
