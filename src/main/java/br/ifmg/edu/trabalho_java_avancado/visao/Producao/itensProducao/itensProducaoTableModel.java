...
public class itensProducaoTableModel extends AbstractTableModel {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        switch (columnIndex){
            ...
            case 1 : return produtos.get(rowIndex).getProd().getNome();
            case 2 : return produtos.get(rowIndex).getQtde();     
        }
        return null;
    }
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        ...
        switch (columnIndex){
            case 0 : produtos.get(rowIndex).setID((Integer)aValue);break;
            case 1 : produtos.get(rowIndex).getProd().setNome((String)aValue);break;
            case 2 : produtos.get(rowIndex).setQtde((Integer)aValue);break;                      
        }      
