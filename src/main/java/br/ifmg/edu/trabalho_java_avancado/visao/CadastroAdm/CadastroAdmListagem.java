 ...
 * @author Vitor
 */
public class CadastroAdmListagem extends javax.swing.JDialog {

    /**
     * Creates new form CadastroVendedorListagem
     */
    
    private final AdmService aService = new AdmService();
    private List<Adm> adms;
    private AdmTableModel aTabModel;
    
    public CadastroAdmListagem(java.awt.Frame parent, boolean modal) {
        super(parent,modal);
        initComponents();
    ...
    private void jBtnIncluirMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBtnIncluirMouseEntered
        ...
        jBtnIncluir.setToolTipText("Neste Botão será possível cadastrar um Administrador!");
    ...
    private void jBtnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnIncluirActionPerformed
        // TODO add your handling code here:
        CadastroAdmInclui dialog = new CadastroAdmInclui(this, true, aService);
    ...
    private void jBtnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnEditarActionPerformed
        ...
        Adm a = adms.get(jTableAdm.getSelectedRow());
        
        CadastroAdmEdita dialog = new CadastroAdmEdita(this, true, aService, a);
        dialog.setVisible(true);
        atualizaDados();
