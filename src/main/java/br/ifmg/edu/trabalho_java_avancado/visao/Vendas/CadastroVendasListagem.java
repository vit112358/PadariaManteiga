 ...
 * @author Vitor
 */
public class CadastroVendasListagem extends javax.swing.JDialog {
    ...
    private void jBtnIncluirMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBtnIncluirMouseEntered
        ...
        jBtnIncluir.setToolTipText("Neste Botão será possível cadastrar uma Venda!");
    ...
    /*public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroVendasListagem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
