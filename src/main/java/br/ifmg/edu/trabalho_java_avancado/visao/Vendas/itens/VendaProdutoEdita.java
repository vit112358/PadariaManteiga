 ...
 * @author vitor
 */
public class VendaProdutoEdita extends javax.swing.JDialog {
    ...
    public VendaProdutoEdita(JDialog parent, boolean modal, VendaProduto produto) {
        super(parent, modal);
        initComponents();
        this.p = produto;
        ...
        jfmtValor.setText(String.valueOf(p.getQtde()));
    }
