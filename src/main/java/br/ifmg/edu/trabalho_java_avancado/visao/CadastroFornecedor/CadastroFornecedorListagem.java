 ...
 * @author Vitor
 */
public class CadastroFornecedorListagem extends javax.swing.JDialog {

    /**
     * Creates new form CadastroVendedorListagem
     */
    
    private final FornecedorService fService = new FornecedorService();
    private List<Fornecedor> fornecedores;
    private FornecedorTableModel fTabModel;
    
    public CadastroFornecedorListagem(java.awt.Frame parent, boolean modal) {
        super(parent,modal);
        initComponents();
    ...
    private void jBtnIncluirMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBtnIncluirMouseEntered
        ...
        jBtnIncluir.setToolTipText("Neste Botão será possível cadastrar um Fornecedor!");
    ...
    private void jBtnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnIncluirActionPerformed
        // TODO add your handling code here:
        CadastroFornecedorInclui dialog = new CadastroFornecedorInclui(this, true, fService);
    ...
    private void atualizaDados() {
       ...
       fornecedores = fService.buscarTodos();
